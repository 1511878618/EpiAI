...
| Sklearn | `"sklearn"` | 一次 fit | 6 | RF, XGB, LGBM, SVR, LinearReg, TabPFN |
| TimeSeries | `"ts"` | 统计推断 | **6** | ARIMA, ETS, **Serfling, STLM, BSTS, Prophet** |
...
| [风险预警模块指南](guides/risk.md) | 风险评分 / 多模型融合 / 预警报告 |
| [模型清单](guides/models.md) | 22 个模型的输入输出与场景 |
| [部署设计文档](deployment-design.md) | 部署架构设计细节 |
| [快速教程](../tutorial/tutorial-dengue.ipynb) | 登革热快速体验：三族模型对比 + 最佳部署 |
| [完整教程](../tutorial/tutorial-full.ipynb) | 留数据 → 训练 → 逐月 feed → 对比 |
| [多特征教程](../tutorial/tutorial-multifeat.ipynb) | 气候特征预测登革热：多特征管道 + 特征重要性 |
